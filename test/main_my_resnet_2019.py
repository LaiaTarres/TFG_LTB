...
escriptura_loss_val = '/imatge/ltarres/PycharmProjects/test/loss_acc/val_loss_'+name_model+'.txt'
escriptura_loss_train = '/imatge/ltarres/PycharmProjects/test/loss_acc/train_loss_'+name_model+'.txt'
escriptura_acc_train = '/imatge/ltarres/PycharmProjects/test/loss_acc/train_acc_'+name_model+'.txt'
escriptura_acc_val = '/imatge/ltarres/PycharmProjects/test/loss_acc/val_acc_'+name_model+'.txt'
...
torch.save(model_ft, 'output_model_'+name_model+'.pth')
...
a_learning_rate='a'
batch_size=int('16') #positive integral value
...
escriptura_loss_val = '/imatge/svillar/Laia/val_loss_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_loss_train = '/imatge/svillar/Laia/train_loss_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_acc_train = '/imatge/svillar/Laia/train_acc_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_acc_val = '/imatge/svillar/Laia/val_acc_'+name_model+'_lre5_bs16_a'+'.txt'

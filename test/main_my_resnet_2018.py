...
print('argument_list: [model_name, model]',argument_list)
print('for example: [my_resnet_18_2018.pth, resnet18]')
name_model=sys.argv[1]
model=sys.argv[2]
epochs=int('60') #integral positive
learning_rate=float('1e-5') #he canviat aixo
a_learning_rate='a'
batch_size=int('16') #positive integral value #també he canviat això
print('ara els paràmetres son: epochs, learning_rate, a_learning_rate, batch_size:'+str(epochs)+', '+str(learning_rate)+', '+str(a_learning_rate)+', '+str(batch_size))


data_dir = '/imatge/ltarres/work/data/ISIC-images/' #tinc moltes carpetes, dues d'elles son train i val.

escriptura_loss_val = '/imatge/ltarres/PycharmProjects/test/loss_acc/val_loss_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_loss_train = '/imatge/ltarres/PycharmProjects/test/loss_acc/train_loss_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_acc_train = '/imatge/ltarres/PycharmProjects/test/loss_acc/train_acc_'+name_model+'_lre5_bs16_a'+'.txt'
escriptura_acc_val = '/imatge/ltarres/PycharmProjects/test/loss_acc/val_acc_'+name_model+'_lre5_bs16_a'+'.txt'
...
if a_learning_rate=='a':
    ...
    exp_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=20, gamma=0.1) #mirar les gràfiques si aquest decay és el que hauria de ser
else:
...
torch.save(model_ft, 'output_model_'+name_model+'_lre5_bs16_a'+'.pth')

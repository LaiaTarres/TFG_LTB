...
model_ft = my_resnet.resnet50(pretrained=True) #carregar un model amb uns weights que ja han fet un train, es descarreguen els weights
...
model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                       num_epochs=60) #s'entrena el model amb la resnet18,

torch.save(model_ft, 'output_model_2018.pth')
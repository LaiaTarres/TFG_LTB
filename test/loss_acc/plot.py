...
filename_train = 'train_acc.txt' #train_acc.txt train_loss.txt
filename_val = 'val_acc.txt' #val_acc.txt val_loss.txt
...
plt.ylabel('loss')
#plt.show()
plt.savefig('acc_train_i_val.png') #loss_train_i_val_2 i acc_train_i_val_2
